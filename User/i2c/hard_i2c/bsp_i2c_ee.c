...
uint32_t I2C_EE_ByteWrite(uint8_t* pBuffer, uint16_t WriteAddr)
{
	...
	status = HAL_I2C_Mem_Write(&I2C_E_Handle, EEPROM_ADDRESS, (uint16_t)WriteAddr, I2C_MEMADD_SIZE_8BIT, pBuffer, 1, 100); 
...
uint32_t I2C_EE_PageWrite(uint8_t* pBuffer, uint16_t WriteAddr, uint8_t NumByteToWrite)
{
	...
	status=HAL_I2C_Mem_Write(&I2C_E_Handle, EEPROM_ADDRESS,WriteAddr, I2C_MEMADD_SIZE_8BIT, (uint8_t*)(pBuffer),NumByteToWrite, 100);
...
uint32_t I2C_EE_BufferRead(uint8_t* pBuffer, uint16_t ReadAddr, uint16_t NumByteToRead)
{
	...
	status=HAL_I2C_Mem_Read(&I2C_E_Handle,EEPROM_ADDRESS,ReadAddr, I2C_MEMADD_SIZE_8BIT, (uint8_t *)pBuffer, NumByteToRead,1000);

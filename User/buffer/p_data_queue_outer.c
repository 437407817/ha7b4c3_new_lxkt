...
p_tx_rx_groupedqueue_init(&q_tx_rx_queue_GROUP_3,&GV_ndb_GROUP_3,q_QUEUE_NODE_NUM_GROUP_3,
	q_QUEUE_NODE_DATA_LEN_GROUP_3,global_elems_GROUP_3,node_data_GROUP_3,global_node_buff_GROUP_3);
	#endif

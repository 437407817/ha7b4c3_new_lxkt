...
void Test_Led_RunningWater(void)
{
    ...
    //485控制引脚
//    HAL_GPIO_WritePin(IO485_01_GPIO_PORT, IO485_01_PIN, GPIO_PIN_SET);
//    HAL_GPIO_WritePin(IO485_02_GPIO_PORT, IO485_02_PIN, GPIO_PIN_SET);
//    HAL_GPIO_WritePin(IO485_03_GPIO_PORT, IO485_03_PIN, GPIO_PIN_SET);
//    HAL_GPIO_WritePin(IO485_04_GPIO_PORT, IO485_04_PIN, GPIO_PIN_SET);
//    HAL_GPIO_WritePin(IO485_05_GPIO_PORT, IO485_05_PIN, GPIO_PIN_SET);

    SYSTEM_DEBUG("[IO TEST] All IO set HIGH, delay 3s\r\n");
    ...
    HAL_GPIO_WritePin(LED01_BOARD_GPIO_PORT, LED01_BOARD_PIN, GPIO_PIN_RESET);
    HAL_GPIO_WritePin(LED02_BOARD_GPIO_PORT, LED02_BOARD_PIN, GPIO_PIN_RESET);
    HAL_GPIO_WritePin(LED03_BOARD_GPIO_PORT, LED03_BOARD_PIN, GPIO_PIN_RESET);
    HAL_GPIO_WritePin(LED04_BOARD_GPIO_PORT, LED04_BOARD_PIN, GPIO_PIN_RESET);
    HAL_GPIO_WritePin(LED05_BOARD_GPIO_PORT, LED05_BOARD_PIN, GPIO_PIN_RESET);

    HAL_GPIO_WritePin(FAN01_GPIO_PORT, FAN01_PIN, GPIO_PIN_RESET);
    HAL_GPIO_WritePin(FAN02_GPIO_PORT, FAN02_PIN, GPIO_PIN_RESET);
    HAL_GPIO_WritePin(FAN03_GPIO_PORT, FAN03_PIN, GPIO_PIN_RESET);
    HAL_GPIO_WritePin(FAN04_GPIO_PORT, FAN04_PIN, GPIO_PIN_RESET);

    HAL_GPIO_WritePin(RE01_GPIO_PORT, RE01_PIN, GPIO_PIN_RESET);
    HAL_GPIO_WritePin(RE02_GPIO_PORT, RE02_PIN, GPIO_PIN_RESET);
    HAL_GPIO_WritePin(RE03_GPIO_PORT, RE03_PIN, GPIO_PIN_RESET);
    HAL_GPIO_WritePin(RE04_GPIO_PORT, RE04_PIN, GPIO_PIN_RESET);
...
//    HAL_GPIO_WritePin(IO485_05_GPIO_PORT, IO485_05_PIN, GPIO_PIN_RESET);
    ...
    SYSTEM_DEBUG("[IO TEST] All IO set LOW, delay 3s\r\n");

...
#define GTP_RCC_II2C_FORCE_RESET()				__HAL_RCC_I2C2_FORCE_RESET()
#define GTP_RCC_II2C_RELEASE_RESET()			__HAL_RCC_I2C2_RELEASE_RESET()
...
#define GET_I2C_SDA()             I2C_SDA_READ()    // 读取SDA端口
#define SET_I2C_SCL()             I2C_SCL_1()	    // 时钟线SCL输出高电平
#define CLR_I2C_SCL()             I2C_SCL_0()       // 时钟线SCL输出低电平
#define SET_I2C_SDA()             I2C_SDA_1()         // 数据线SDA输出高电平
#define CLR_I2C_SDA()             I2C_SDA_0()        // 数据线SDA输出低电平

#define CLR_RST_IO()             HAL_GPIO_WritePin(GTP_RST_GPIO_PORT, GTP_RST_GPIO_PIN,GPIO_PIN_RESET) 
#define SET_RST_IO()             HAL_GPIO_WritePin(GTP_RST_GPIO_PORT, GTP_RST_GPIO_PIN,GPIO_PIN_SET) 
#define CLR_INT_IO()             HAL_GPIO_WritePin(GTP_INT_GPIO_PORT, GTP_INT_GPIO_PIN,GPIO_PIN_RESET) 
#define SET_INT_IO()             HAL_GPIO_WritePin(GTP_INT_GPIO_PORT, GTP_INT_GPIO_PIN,GPIO_PIN_SET) 
